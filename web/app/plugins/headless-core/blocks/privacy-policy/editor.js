(function (blocks, blockEditor, components, element, i18n) {
  ...
  var boot = window.headlessPrivacyPolicyDefaults || {};
  var DEFAULT_SECTION_TITLE = boot.sectionTitle || 'PORTS SACCO Privacy Policy';
  ...
  function normalizeSection(section, index) {
    ...
    var id = row.id ? String(row.id) : ('pp-pending-' + index);
  ...
  function ensureSectionIds(sections) {
    ...
    var next = sections.map(function (section, index) {
      ...
      if (normalized.id && normalized.id.indexOf('pp-pending-') !== 0) {
        return normalized;
      }
      changed = true;
  ...
  registerBlockType('custom/privacy-policy', {
    apiVersion: 3,
    title: __('Privacy Policy', 'headless-core'),
    icon: 'privacy',
    category: 'widgets',
    description: __('Modern privacy policy page with drag-and-drop reorderable sections and editable bullet lists.', 'headless-core'),
    attributes: {
    ...
    edit: function (props) {
      ...
      var blockProps = useBlockProps({
        className: 'headless-privacy-policy-block',
        style: {
      ...
      return el(
        ...
        el(RichText, {
          ...
          allowedFormats: [],
          placeholder: __('Privacy policy title…', 'headless-core'),
          style: {
            margin: '0 0 8px',
        ...
        el(RichText, {
          ...
          allowedFormats: [],
          placeholder: __('Intro paragraph…', 'headless-core'),
          style: {
            margin: '0 0 20px',
        ...
        sections.map(function (section, index) {
          var sectionId = section.id || ('pp-pending-' + index);
          ...
          return el(
            ...
            el(
              ...
              el(RichText, {
                identifier: 'pp-content-' + sectionId,
                tagName: 'div',
                multiline: 'p',
