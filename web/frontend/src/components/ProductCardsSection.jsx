    ...
    <div id="products" className="relative bg-[#F5F4EE] pt-0 pb-10 overflow-visible" style={{ fontFamily: 'Sans-serif, Helvetica, sans-serif' }}>
      ...
      <div className="max-w-7xl mx-auto px-4" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 justify-items-center">
          {/* Card 1: Join Us */}
          <a href="#" className="group block relative w-full max-w-[350px] cursor-pointer" style={{ filter: 'drop-shadow(0px 4px 10px rgba(0, 0, 0, 0.1))', animation: 'slideInCard 0.6s ease-out' }}>
            {/* Image Section */}
            <div className="relative overflow-visible rounded-t-3xl">
              ...
              <div className="content relative overflow-visible z-0 -top-6">
                <div className="relative p-6 bg-white w-full " style={{ clipPath: 'url(#card-clip)', borderTopLeftRadius: '15px', borderTopRightRadius: '15px' }}>
                  ...
                  <h3 className="text-2xl text-[#22ACB6] mb-3" style={{ fontFamily: 'Museo, sans-serif', fontWeight: 900 }}>Join Us</h3>
                ...
                {/* Button positioned in S-curve corner - hover styles when card or button hovered */}
                <span
                  className="absolute bg-white text-[#3b4e6b] rounded-full group-hover:bg-[#EE6E2A] group-hover:text-white transition-colors z-10 flex items-center justify-center pointer-events-none"
            ...
            <div className="relative overflow-visible rounded-t-3xl">
              ...
              <div className="content relative -mt-7 overflow-visible">
                <div className="relative p-6 bg-white w-full" style={{ clipPath: 'url(#card-clip)', borderTopLeftRadius: '15px', borderTopRightRadius: '15px' }}>
                  ...
                  <h3 className="text-2xl text-[#22ACB6] mb-3" style={{ fontFamily: 'Museo, sans-serif', fontWeight: 900 }}>SecureYour Future</h3>
                  <p className="text-[#3b4e6b] text-sm mb-4">
            ...
            <div className="relative overflow-visible rounded-t-3xl">
              ...
              <div className="content relative -mt-7 overflow-visible">
                ...
                <div className="relative p-6 bg-white w-full" style={{ clipPath: 'url(#card-clip)', borderTopLeftRadius: '15px', borderTopRightRadius: '15px' }}>
                  ...
                  <h3 className="text-2xl text-[#22ACB6] mb-3" style={{ fontFamily: 'Museo, sans-serif', fontWeight: 900 }}>Flexible Loan Options</h3>
                  <p className="text-[#3b4e6b] text-sm mb-4">
