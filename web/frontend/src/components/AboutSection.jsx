  ...
  return (
    <div id="about" className="relative bg-white pt-0 pb-10 overflow-visible flex flex-col" style={{ fontFamily: 'Sans-serif, Helvetica, sans-serif'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 text-center mb-0">
        ...
        <Link 
          to="/about-us" 
          className="inline-flex items-center gap-2 text-[#3b4e6b] text-sm hover:text-[#22ACB6] transition-colors"
        >
          <span>READ MORE</span>
          <div className="relative w-5 h-5 flex items-center justify-center">
            {/* Circular teal background (circle only, no arrow shape) */}
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 24 24">
              <circle cx="12" cy="12" r="12" fill="#22ACB6" />
            </svg>
            {/* Arrow right icon (Lucide style) */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
