    ...
    <div id="services" className="relative bg-gradient-to-r from-[#00B2E0] via-[#00AFBB] to-[#00AB81] text-white pt-0 pb-28 overflow-visible">
      ...
      <div className="max-w-7xl mx-auto px-4" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
        ...
        <div className="bg-white rounded-3xl p-12 mt-12">
          <h2 className="text-[21px] text-[#3b4e6b] mb-2" style={{ fontFamily: 'Museo, sans-serif', fontWeight: 900 }}>
          ...
          <div className="mb-8 flex items-center gap-[1px]">
            <div className="relative flex-1">
              <select className="text-[#3b4e6b] text-[12px] font-bold bg-[#38f0ba] border border-[#e8e8e8] px-4 py-3 rounded-full appearance-none cursor-pointer w-full" style={{ fontFamily: 'Sans-serif, Helvetica, sans-serif', fontWeight: 900, paddingRight: '38px' }}>
