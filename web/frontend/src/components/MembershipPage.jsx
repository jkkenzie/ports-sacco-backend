...
export function MembershipPage() {
  ...
  const { blocks, status } = useWpPage('membership');
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-[#65605f]">
          Create a published WordPress page with slug <code className="text-sm">membership</code>.
        </p>
      </div>
    );
  }
  ...
  if (status.error) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center text-red-600 text-sm space-y-2">
        ...
        <p className="text-[#65605f]">
          Test the API:{' '}
          <a className="text-[#22abb5] underline" href="/wp-json/portsacco/v1/page/membership" target="_blank" rel="noreferrer">
            /wp-json/portsacco/v1/page/membership
          </a>
        </p>
      </div>
    );
          ...
          {otherBlocks.length > 0 ? (
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 text-center text-neutral-500 text-sm">
              ...
              <p className="mt-2 text-xs">
                Loaded {blocks.length} block(s) from the API. Add membership content blocks in WordPress if this is
                unexpected.
              </p>
            </div>
          )}
